...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset_path", type=str, default="./data/test_features", help="Path to input dataset")
    parser.add_argument("--checkpoint_model", type=str, default="../saved_models/TPose/T_Pose_model_final.pth", help="Optional path to checkpoint model")
    ...
    model = SSTCN_Pose_model(frames_number=60,joints_number=33,
        n_classes=226
    )
    ...
    for name in tqdm(test_files[0]):
        ...
        preds.append(pred)
    with open('./test_feature_w_val_finetune.pkl', 'wb') as f:
